...
public class popularVehiculos {
    ...
    public static List<Vehiculo> popularCoches() {
        ...
        coches.add(new Coche(2, 0, 0, 9000.0, "PQR678", "Volkswagen", 4, 100.0, false, false)); // Sin pago
        coches.add(new Coche(1, 1, 0, 13000.0, "STU901", "Kia", 5, 100.0, false, false)); // Sin pago

        coches.add(new Coche(1, 2, 2, 11000.0, "YZA567", "Renault", 4, 100.0, true, false)); // Pago parcial
        coches.add(new Coche(0, 4, 3, 19000.0, "VWX234", "Hyundai", 4, 100.0, true, false)); // Pago parcial

        coches.add(new Coche(0, 4, 4, 21000.0, "BCD890", "Peugeot", 5, 100.0, false, true)); // Pago total
        coches.add(new Coche(2, 2, 4, 17000.0, "MNO345", "Nissan", 5, 100.0, false, true)); // Pago total
    ...
    public static List<Vehiculo> popularMotos() {
        ...
        motos.add(new Moto(1, 1, 1, 11000.0, "GHI901", "Triumph", 550, 100.0, true, false)); // Pago parcial
        motos.add(new Moto(1, 1, 1, 12500.0, "ZYX890", "Aprilia", 700, 100.0, true, false)); // Pago parcial


        motos.add(new Moto(0, 2, 2, 8500.0, "UVW456", "Suzuki", 300, 100.0, false, true)); // Pago total
        motos.add(new Moto(0, 2, 2, 10000.0, "LMN345", "Harley-Davidson", 100, 200.0, false, true)); // Pago total
        motos.add(new Moto(0, 2, 2, 11500.0, "DEF234", "KTM", 600, 100.0, false, true)); // Pago total
